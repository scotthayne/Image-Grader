...
def analyze_facial_features(image_path):
    ...
    try:
        ...
        if img is None: return {'eyes_open': 0, 'smile_score': 0, 'face_size': 0}
        ...
        with mp_face_mesh.FaceMesh(static_image_mode=True, max_num_faces=1, refine_landmarks=True) as face_mesh:
            ...
            if not results.multi_face_landmarks:
                return {'eyes_open': 0, 'smile_score': 0, 'face_size': 0}
            ...
            # --- UPDATED SCALING FOR 0-50 RANGE ---
            ...
            return {'eyes_open': eyes_open, 'smile_score': smile_score, 'face_size': face_size_percentage}
        ...
        for i, image_path in enumerate(all_files):
            ...
            if is_blank(image_path):
                ...
                if quality_metrics and facial_features['face_size'] > 0:
                    ...
                    sharpness_score = min(quality_metrics['sharpness'] / 133.0, 10) # Scaled to 10
                    contrast_score = min(quality_metrics['contrast'] / 10.0, 10)    # Scaled to 10
                    brightness_score = max(0, 10 - abs(quality_metrics['brightness'] - 128) / 12.8) # Remains 10
                    quality_score = sharpness_score + contrast_score + brightness_score
                    
                    # Total Score (Smile is up to 50)
