...
# --- CORRECTED Landmark Indices for Eye Aspect Ratio ---
...
def analyze_facial_features(image_path):
    """Analyzes facial features using a combination of MediaPipe and Haar Cascades."""
    try:
        ...
        # --- Smile, Teeth, Face Size (Haar Cascades) ---
        faces = FACE_CASCADE.detectMultiScale(gray, 1.3, 5)
        if len(faces) == 0: return {'eyes_open': eyes_open, 'smiles': 0, 'teeth_showing': 0, 'face_size': 0}
        ...
        return {'eyes_open': eyes_open, 'smiles': has_smile, 'teeth_showing': teeth_showing, 'face_size': face_size_percentage}
    except Exception:
