...
def write_grade_to_exif(image_path, score):
    """Writes only the grade to the image's EXIF data."""
    try:
...
def add_5_star_rating(image_path):
    """Adds a 5-star rating to an image's EXIF data, preserving other tags."""
    try:
        exif_dict = piexif.load(image_path)
    except Exception:
        exif_dict = {"0th": {}, "Exif": {}, "GPS": {}, "1st": {}, "thumbnail": None}
