...
def is_blank(image_path, brightness_threshold):
    """
    Determines if an image is blank based on its average brightness.
    This is the single point of truth for blank detection.
    """
    try:
        ...
        return True # Treat any error during analysis as a blank
