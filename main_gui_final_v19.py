...
class App(ctk.CTk):
    ...
    def process_completed_set(self, set_data, dest_dir):
        ...
        qualified_images = [img for img in set_data if img[3]] # Filter for eyes_open
        ...
        # Primary Logic: Find best close-up and long-shot
        ...
        # Fallback Logic: If we don't have two keepers, take the top two overall
        ...
        # Copy final keepers to destination
        for keeper_path in set(keepers): # Use set to avoid duplicates
