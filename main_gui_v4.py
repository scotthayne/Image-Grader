...
class App(ctk.CTk):
    def __init__(self):
        ...
        self.close_up_threshold = 20.0 # Face width > 20% of image width
            ...
            for image_path in image_set:
                ...
                if quality_metrics and facial_features['face_size'] > 0:
                    ...
                    if is_closeup:
                        ...
                        elif total_score == best_closeup_score and (best_closeup is None or os.path.basename(image_path) > os.path.basename(best_closeup)):
                            best_closeup = image_path
                    else: # Is a long-shot
                        if total_score > best_longshot_score:
                            best_longshot_score = total_score
                            best_longshot = image_path
                        elif total_score == best_longshot_score and (best_longshot is None or os.path.basename(image_path) > os.path.basename(best_longshot)):
                            best_longshot = image_path
